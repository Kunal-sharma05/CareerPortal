  ...
  return (
    <div className='w-[20vw] h-[27vw] bg-zinc-200 p-3 rounded-md relative'>
        ...
        <div className="w-full p-3">
            ...
            <button  onClick={onClickHandler} className={` px-2 py-1 bottom-4 text-xs text-white ${applied ? 'bg-green-700' : "bg-blue-500"} font-semibold rounded-md absolute`}> {applied ?"Applied":"Apply"} </button>
        </div>
    </div>
  )
}
