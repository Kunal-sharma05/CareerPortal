...
public class EmployerDTO {
    ...
    public EmployerDTO(Long employerId, String fullName, String companyName, String mobileNo, String email) {
	...
	public String toString() {
		return "EmployerDTO [employerId"+ employerId +", fullName=" + fullName + ", companyName=" + companyName + ", mobileNo=" + mobileNo
				+ ", email=" + email + "]";
	}
