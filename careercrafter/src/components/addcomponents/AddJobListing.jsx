...
export const AddJobListing = () => {
    ...
    useEffect(() => {
        ...
        if (id) {
            JobListingService.getJobListingById(id).then((response) => {
                ...
                <div className="card col-md-6 offset-md-3">
                    ...
                    <div className="card-body">
                        <form>
                            ...
                            {/* submit-button  */}
                            <button onClick={(e) => saveOrUpdateJobListing(e)} className='btn btn-success'>Save JobListing</button>&nbsp;&nbsp;
                            <Link to="/jobListing" className='btn btn-danger'>Cancel</Link>
                        </form>
                    </div>
                </div>
