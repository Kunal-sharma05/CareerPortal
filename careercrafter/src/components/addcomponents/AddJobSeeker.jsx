                    ...
                    <div className="card-body">
                        <form>
                            ...
                            <div className="form-group mb-2">
                                <label className="form-label">Full Name of the Job seeker</label>
                                <input
                                    type="text"
                            ...
                            <div className="form-group mb-2">
                                <label className="form-label">Professional details of the job seeker</label>
                                <input
                                    type="text"
                            ...
                            <div className="form-group mb-2">
                                <label className="form-label">educational details of the job seeker</label>
                                <input
                                    type="text"
                            ...
                            <div className="form-group mb-2">
                                <label className="form-label">Moblile number of the job seeker</label>
                                <input
                                    type="text"
                            ...
                            {/* submit-button  */}
                            <button onClick={(e) => saveOrUpdateJobSeeker(e)} className='btn btn-success'>Save JobSeeker</button>&nbsp;&nbsp;
                            <Link to="/jobSeeker" className='btn btn-danger'>Cancel</Link>
                        </form>
                    </div>
                </div>
